...
const Assignments = () => {
    ...
    return (
        <div>
            ...
            {
                filteredAssignments.map(i=> <div key={i._id} className="card w-96 bg-base-100 border shadow-xl">
                ...
                <div className="card-body">
                  ...
                  <Link to={`/updateAssignment/${i._id}`} ><button className="btn btn-secondary">Update</button></Link>
                  <div className="card-actions justify-end">
                    <Link to={`/viewDetails/${i._id}`} ><button className="btn btn-primary">view Assignment datils</button></Link>
                  </div>
                </div>
              </div>)
            }
